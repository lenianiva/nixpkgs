...
- [Concourse CI](https://concourse-ci.org/), an open-source continuous thing-doer. Available with [services.concourse-web](#opt-services.concourse-web.enable) and [services.concourse-worker](#opt-services.concourse-worker.enable)
